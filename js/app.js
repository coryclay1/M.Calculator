...
document.getElementsByTagName('form')[0].addEventListener("submit", (event) => {
    ...
    document.getElementsByClassName("mg-page__right")[0].classList.add
    ("mg-page__right--animate");
    calculateData()
})
...
function calculateData(){
    ...
    monthlyTotal =
    parseFloat(monthlyPrincipalInterest) + parseFloat(monthlyPropertyTaxes) + parseFloat(monthlyHomeInsurance)
    + parseFloat(monthlyHOA);

    //targeting the html to change once the circle bar is moved
